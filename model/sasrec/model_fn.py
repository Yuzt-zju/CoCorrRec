...
class SasRec(nn.Module):
    def __init__(self, model_conf):
        ...
        # configuration = TTTConfig(hidden_size=model_conf.id_dimension,num_attention_heads=model_conf.nhead,mini_batch_size=1024)
        # self._transformer = TTTLinear(configuration,model_conf.mlp_layers)
